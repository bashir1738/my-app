...
const Modal = ({ isVisible, onclose }) => {
  ...
  const sign = async () => {
    ...
    console.log(data)
    // const result = await axios.post('http://192.168.43.41:1212/api/v1/auth/register', data)
    // .then((response) => {
      ...
      <div className='w-[340px] md:w-[430px]  '>
        <div className=' bg-white p-3 rounded-lg shadow-xl mt-3' >
          ...
          <div className='flex flex-row'>  
            ...
            <div className='pt-3'>
              <input required className='p-2 w-full outline-gray-200' placeholder='Mobile Number or Email Address' type='Email' value={Email} onChange={(e) => setEmail(e.target.value)}   />
            </div>
            <div className='pt-3'>
              <input required className='p-2 w-full outline-gray-200' placeholder='New password' type='password' value={Password} onChange={(e) => setPassword(e.target.value)} />
            </div>
            <div>
              ...
              <div className='flex flex-row'>
                <div className='mr-3 border border-neutral-400 w-full h-9'>
                  <select className=" w-full h-full" onChange={(e) => setDay(e.target.value)}>
                ...
                <div className=' mr-3 border border-neutral-400 w-full h-9'>
                  <select className=" w-full h-full" onChange={(e) => setMonth(e.target.value)}>
                ...
                <div className=' border border-neutral-400 w-full h-9'>
                  <select className=" w-full h-full" onChange={(e) => setYear(e.target.value)}>
            ...
            <div className='flex items-center justify-center pt-4 pb-4'>
              <button className='bg-green-600 hover:bg-green-700 p-2 font-bold  text-white hover:text-gray-100  rounded-lg text text-1xl w-[200px]  ' onClick={() => sign()}>
                Sign up
              </button>
            </div>
            </form>
